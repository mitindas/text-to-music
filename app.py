...
demo = gr.Interface(
    fn=generate_audio,
    inputs=[
        gr.Text(label="Text Prompt", value="80s pop track with synth and instrumentals"),
        gr.Slider(10, 30, value=15, step=5, label="Audio Length (seconds)"),
    ],
    outputs=gr.Audio(label="Generated Music", interactive=False),
    title=title,
    flagging_mode="never"
)
